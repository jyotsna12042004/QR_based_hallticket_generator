            ...
            <div class="row">
                <center><div class="col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="file" class="form-control" id="subject" name="pphoto" placeholder="Name">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Address" name="address" id="message" style="height: 150px"></textarea>
